...
function MainPage() {
  return (
    <div className="main--page">
      <h1 className="main--page--top--name text-3xl font-bold text-black text-center mt-10">
        saumyareddy
      </h1>
      ...
      <div className="profile">
        <img src={saumya} className="profile--image ml-12 mt-10" />
        ...
        <p className="font-200 text-1xl ml-5 mt-5 mr-5">
          Based in India, I am a software engineer and a passionate fullstack
